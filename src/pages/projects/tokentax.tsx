...
const tokenTaxProjectData = {
  ...
  descriptionList: [
    "SEO work for the marketing site, which included building out schemas and working with React Helmet",
    "RESTful api and front-end components for admin commenting feature",
    "working with React Table to maintain accounting tools",
  ],
  links: [
    {
